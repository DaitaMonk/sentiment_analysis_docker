...
if st.button("Contact Me via Email"):
    st.markdown('<a href="mailto:kodwoam@gmail.com">Send Email</a>',
                unsafe_allow_html=True)

# Button to visit LinkedIn profile
if st.button("Visit My LinkedIn Profile"):
    st.markdown('<a href="https://www.linkedin.com/in/kodwoamissahmensah">LinkedIn</a>',
                unsafe_allow_html=True)

# Button to visit medium
if st.button("Read my blogs"):
    st.markdown('<a href="https://medium.com/@kodwoam">Medium</a>',
                unsafe_allow_html=True)

# Button to github
if st.button("Check out my github repositories"):
    st.markdown('<a href="https://github.com/KodwoAmissah">github</a>',
                unsafe_allow_html=True)
...
# Button to send an email
if st.button("Email"):
    st.markdown('<a href="mailto:rndcrabbe@gmail.com">Send Email</a>',
                unsafe_allow_html=True)

# Button to visit LinkedIn profile
if st.button("LinkedIn Profile"):
    st.markdown('<a href="http://www.linkedin.com/in/regina-crabbe-ab11a5284">LinkedIn</a>',
                unsafe_allow_html=True)

# Button to visit medium
if st.button("Medium"):
    st.markdown('<a href="https://medium.com/@rndcrabbe">Medium</a>',
                unsafe_allow_html=True)

# Button to github
if st.button("Github"):
    st.markdown('<a href="https://github.com/reginacrabbe">github</a>',
                unsafe_allow_html=True)
...
if st.button("Send Email"):
    st.markdown('<a href="mailto:adebayoaliyyah2020@gmail.com">Send Email</a>',
                unsafe_allow_html=True)

# Button to visit LinkedIn profile
if st.button("LinkedIn"):
    st.markdown('<a href="https://www.linkedin.com/in/aliyyah-adebayo-88a540233">LinkedIn</a>',
                unsafe_allow_html=True)

# Button to visit medium
if st.button("Blog"):
    st.markdown('<a href="https://medium.com/@adebayoaliyyah2020/">Medium</a>',
                unsafe_allow_html=True)

# Button to github
if st.button("Github Repository"):
    st.markdown('<a href="https://github.com/Aliyyah22">github</a>',
                unsafe_allow_html=True)
...
if st.button("Contact through email"):
    st.markdown('<a href="mailto:momohalvin3@gmail.com">Send Email</a>',
                unsafe_allow_html=True)

# Button to visit LinkedIn profile
if st.button("View LinkedIn Profile"):
    st.markdown('<a href="http://www.linkedin.com/in/alvinmomoh">LinkedIn</a>',
                unsafe_allow_html=True)

# Button to visit medium
if st.button("Article"):
    st.markdown('<a href="https://medium.com/@chipmnkal/">Medium</a>',
                unsafe_allow_html=True)

# Button to github
if st.button("Check out my github"):
    st.markdown('<a href="https://github.com/DaitaMonk">github</a>',
                unsafe_allow_html=True)
...
if st.button("Personal email"):
    st.markdown('<a href="mailto:realeonallen@gmail.com">Send Email</a>',
                unsafe_allow_html=True)

# Button to visit LinkedIn profile
if st.button("LinkedIn_Profile"):
    st.markdown('<a href="https://LinkedIn.com/in/leo-allen">LinkedIn</a>',
                unsafe_allow_html=True)

# Button to visit medium
if st.button("Blog account"):
    st.markdown('<a href="https://medium.com/@leon.maina">Medium</a>',
                unsafe_allow_html=True)

# Button to github
if st.button("View github"):
    st.markdown('<a href="https://GitHub.com/realeonallen">github</a>',
                unsafe_allow_html=True)
